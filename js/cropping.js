document.addEventListener("DOMContentLoaded", function () {
  ...
  // Function to get all files for upload
  function getFilesForUpload() {
    // Return the cropped files where available, falling back to original files where not
    return selectedFiles.map((file, index) => croppedFiles[index] || file);
  }
